...
public class HangManGameStateManager {
    ...
    /**
     * Resets the game data when the language is selected, since home button allows or changing languages, the game data should not be shared
     */
    ...
    /**
     * Gets the HangManUI ui
     * @return HangManUI ui
     */
    public HangManUI getUI()
    {
        return ui;
    }
    
    /**
     * sets currentGameState to HangManState.GAME_OVER
     */
    public void setGameNotInProgress()
    {
        gameInProgress.giveUp();
        currentGameState = HangManGameState.GAME_OVER;
    ...
    public void setState(HangManGameState state)
    {
        currentGameState = state;
    }
    
    public ArrayList<HangManGameData> getHistory()
    {
        return gamesHistory;
    }
}
